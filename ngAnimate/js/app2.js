...
function AppController ($scope, $rootScope, $http, $timeout) {
	...
	$scope.mesToDos = [
	{'name':'tache 1','isShow':false}
	,{'name':'tache 2','isShow':false}
	,{'name':'tache 3','isShow':false}
	];
	...
	$scope.faireTourner = function () {
		//$scope.isShow = !$scope.isShow;
		angular.forEach($scope.mesToDos, function(itemToDo)
		{
			itemToDo.isShow = !itemToDo.isShow;
